...
Este projeto foi desenvolvido com o auxílio de Inteligência Artificial, utilizando o ChatGPT da OpenAI como ferramenta de apoio para planejamento, estruturação e geração de código.

A proposta foi criar uma plataforma de cursos online voltada para o setor agrícola, contendo uma interface moderna, responsiva e intuitiva para estudantes e profissionais do agronegócio.
